...
class Auth {
  ...
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      ...
      // exisinting user - redirect them to the home page 
      (0, _Router.gotoRoute)('/');
    }
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","gsap":"../node_modules/gsap/index.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/joke.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"joke\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Jokes</h1>\n        <p>Joking ...</p>\n\n        ", "\n        \n      \n\n        \n      </div>      \n    "]);
...
class JokeView {
  ...
  async getJoke() {
    const response = await fetch('https://api.chucknorris.io/jokes/random'); // Problem if getting repsonse 
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.joke ? (0, _litHtml.html)(_templateObject2(), this.joke.value) : (0, _litHtml.html)(_templateObject3()));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new JokeView();
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/hairdresses.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Hairdresses\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Hairdresses</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "]);
...
class HairdressesView {
  init() {
    document.title = 'Hairdresses';
    this.render();
...
var _default = new HairdressesView();
...
class HaircutAPI {
  async newHaircut(formData) {
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem creating haircuts');
    } // convert response payload into json - store as data
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <style>\n        .filter-menu{\n          display: flex;\n          align-items: center;\n\n        }\n\n        .filter-menu > div {\n          margin-right: 1em;\n        }\n      \n      </style>\n\n\n      <va-app-header title=\"Haircuts\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-content\">        \n        <h1>Haircuts</h1>\n\n        <div class=\"filter-menu\">\n\n          <div>\n            Filter by\n          </div>\n\n          <div>\n            <strong>Gender</strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"gender\" data-match=\"f\" @click=", ">F</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"gender\" data-match=\"u\" @click=", ">U</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"gender\" data-match=\"m\" @click=", ">M</sl-button>\n          </div>\n\n          <div>\n            <strong>Length</strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"length\" data-match=\"s\" @click=", ">S</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"length\" data-match=\"m\" @click=", ">M</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"length\" data-match=\"l\" @click=", ">L</sl-button>\n          </div>\n\n          <div>\n            <strong>Price</strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"10-20\" @click=", ">$10-20</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"20-30\" @click=", ">$20-30</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"30-40\" @click=", ">$30-40</sl-button>\n          </div>\n\n          <div>\n            <sl-button size=\"small\" @click=", ">Clear Filters </sl-button>\n          </div>\n        \n        </div>\n        \n        <div class=\"haircuts-grid\">\n          ", "\n\n\n        </div>\n        \n      </div>      \n    "]);
...
class HaircutsView {
  ...
  async filterHaircuts(field, match) {
    ...
    if (!field || !match) return; // get fresh copy of haitcuts 

    this.haircuts = await _HaircutAPI.default.getHaircuts();
    let filteredHaircuts; // gender 
    ...
    if (field == 'price') {
      ...
      const priceRangeStart = match.split('-')[0]; // get the price range end 
  ...
  handleFilterBtn(e) {
    ...
    this.clearFilterBtns(); //set button active (primary attribute)

    e.target.setAttribute("type", "primary"); //extract filed nad match

    const field = e.target.getAttribute("data-field");
    const match = e.target.getAttribute("data-match"); //filter the haircuts
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.haircuts == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.haircuts.map(haircut => (0, _litHtml.html)(_templateObject4(), haircut._id, haircut.name, haircut.description, haircut.price, JSON.stringify(haircut.user), haircut.image, haircut.gender, haircut.length))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteHaircuts.js":[function(require,module,exports) {
"use strict";
...
class newHaircutView {
  ...
  async newHaircutSubmitHandler(e) {
    ...
    try {
      ...
      if (textInputs) textInputs.forEach(textInputs => textInputs.value = null); // reset radio inputs

      const radioInputs = document.querySelectorAll('sl-radio');
      if (radioInputs) radioInputs.forEach(radioInputs => radioInputs.removeAttribute('checked')); // reset img file
...
var _joke = _interopRequireDefault(require("./views/pages/joke"));

var _guide = _interopRequireDefault(require("./views/pages/guide"));

var _hairdresses = _interopRequireDefault(require("./views/pages/hairdresses"));
...
const routes = {
  ...
  '/hairdresses': _hairdresses.default,
  '/haircuts': _haircuts.default,
  '/favourite': _favouriteHaircuts.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/joke":"views/pages/joke.js","./views/pages/guide":"views/pages/guide.js","./views/pages/hairdresses":"views/pages/hairdresses.js","./views/pages/haircuts":"views/pages/haircuts.js","./views/pages/favouriteHaircuts":"views/pages/favouriteHaircuts.js","./views/pages/newHaircut":"views/pages/newHaircut.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
class App {
  ...
  init() {
    ...
    _Toast.default.init(); // No need Authentication check  
    //Auth.check(() => {
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n    <style>      \n      * {\n        box-sizing: border-box;\n      }\n\n      .app-header {\n        position: fixed;\n        top: 0;\n        right: 0;\n        left: 0;\n        height: var(--app-header-height);\n        color: black;\n        display: flex;\n        z-index: 9;\n        align-items: center;\n        margin-top: 2%;\n\n\n      }\n      \n\n      .app-header-main {\n        flex-grow: 1;\n        display: flex;\n        align-items: center;\n        \n      }\n\n      .app-header-main::slotted(h1){\n        color: black;\n      }\n\n      .app-logo a {\n        color: black;\n        text-decoration: none;\n        font-weight: bold;\n        font-size: 1.2em;\n        padding: .6em;\n        display: inline-block;  \n        margin-top: 4%;\n      \n      }\n\n      .app-logo img {\n        width: 90px;\n      }\n      \n      .hamburger-btn::part(base) {\n        color: black;\n      }\n\n      .app-top-nav {\n        display: flex;\n        height: 100%;\n        align-items: center;\n      }\n\n      .app-top-nav a {\n        display: inline-block;\n        padding: .8em;\n        text-decoration: none;\n        color: black;\n      }\n      \n      .app-side-menu-items a {\n        display: block;\n        padding: .5em;\n        text-decoration: none;\n        font-size: 1.3em;\n        color: #333;\n      }\n\n      .app-side-menu-logo {\n        width: 120px;\n        margin-bottom: 1em;\n        position: absolute;\n        top: 2em;\n        left: 1.5em;\n      }\n\n      .page-title {\n        color: var(--app-header-txt-color);\n        margin-right: 0.5em;\n        font-size: var(--app-header-title-font-size);\n      }\n\n      /* active nav links */\n      .app-top-nav a.active,\n      .app-side-menu-items a.active {\n        font-weight: bold;\n        color: black;\n      }\n\n      /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 768px){       \n        \n        .app-top-nav {\n          display: none;\n        }\n      }\n\n    </style>\n\n    <header class=\"app-header\">\n      <sl-icon-button class=\"hamburger-btn\" name=\"list\" @click=\"", "\" style=\"font-size: 1.5em;\"></sl-icon-button>       \n      \n      <div class=\"app-header-main\">\n        ", "\n        <slot></slot>\n      </div>\n\n      <nav class=\"app-top-nav\">\n        <a href=\"/\" @click=\"", "\">2021</a>   \n        ", "  \n\n   \n        <sl-dropdown>\n          <a slot=\"trigger\" href=\"#\" @click=\"", "\">\n          </a>\n          <sl-menu>            \n            <sl-menu-item @click=\"", "\">What I do</sl-menu-item>\n            <sl-menu-item @click=\"", "\">My projects</sl-menu-item>\n            <sl-menu-item @click=\"", "\">Get to know </sl-menu-item>\n            <sl-menu-item @click=\"", "\">Contact me</sl-menu-item>\n          </sl-menu>\n        </sl-dropdown>\n      </nav>\n    </header>\n\n    <sl-drawer class=\"app-side-menu\" placement=\"left\">\n      <nav class=\"app-side-menu-items\">\n        <a href=\"/\" @click=\"", "\">Home</a>\n        <a href=\"/\" @click=\"", "\">What I do </a>\n        <a href=\"/\" @click=\"", "\">My Projects</a>         \n        <a href=\"/joke\" @click=\"", "\">Joke</a>\n        <a href=\"/\" @click=\"", "\">Let's work together</a>\n        <a href=\"/\" @click=\"", "\">Contact me</a>\n      </nav>  \n    </sl-drawer>\n    "]);
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject4()), e => e.preventDefault(), () => (0, _Router.gotoRoute)('/'), () => (0, _Router.gotoRoute)('/joke'), () => (0, _Router.gotoRoute)('/'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick);
  }
...
customElements.define('va-haircut', class Haircut extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.name, this.name, this.description, this.price, this.gender, this.length, this.addFavHandler.bind(this));
    (0, _litHtml.render)(dialogContent, dialogEl); // append to body 

    document.body.append(dialogEl); // show dialoge 

    dialogEl.show(); // on hide, delete the dialoge el
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.price, this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }
